    ...
    <div class="container" id="tabs-container">
      ...
      <div class="left-col" id="toolbox-col" style="padding-top: 18px">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active" style="padding: 20px; display: none"" id="add-field">		   
            ...
            <div class="col-sm-6">
			  ...
			  <button class="button new-element" data-type="element-date-time" style="width: 100%;">date-time</button>
            </div>
			</div>
